...
const PORTFOLIO_DATA = {
  ...
  highlights: [
    ...
    { icon: "🏗️", label: "Exploring Full Stack" },
    { icon: "🌐", label: "IoT Enthusiast" },
  ...
  skills: [
    ...
    },
    {
      ...
      icon: "🚀",
      items: [
        { name: "Spring Boot", level: 20, badge: "Learning" },
        { name: "React", level: 15, badge: "Learning" },
        { name: "Microservices", level: 10, badge: "Learning" },
        { name: "Digital Twin Tech", level: 25, badge: "Research" },
      ],
    },
  ],
  ...
  journey: [
    ...
    },
    {
      ...
      description: "Picked up Python for scripting and automation. Built small projects to sharpen logic skills.",
      icon: "🐍",
      type: "skill",
    },
    {
    ...
    {
      year: "2024",
      title: "Exploring IoT & Digital Twin",
      description: "Began research into IoT systems, sensor networks, and Digital Twin technology as part of my B.Tech focus.",
      icon: "🌐",
      type: "research",
    },
    {
      ...
      description: "Started learning web development in depth — HTML, CSS, JavaScript — building toward full-stack capability.",
      icon: "🏗️",
      type: "skill",
    },
    {
